...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/mc/RunIISpring16MiniAODv2/TTbarDMJets_pseudoscalar_Mchi-1_Mphi-100_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/MINIAODSIM/PUSpring16RAWAODSIM_80X_mcRun2_asymptotic_2016_miniAODv2_v0_ext1-v1/40000/C06A61EE-EF25-E611-870A-02163E011A12.root')
    #fileNames = cms.untracked.vstring('file://eos/cms/store/relval/CMSSW_8_0_10/RelValTTbar_13/MINIAODSIM/80X_mcRun2_asymptotic_v14-v1/00000/246EEC77-D528-E611-988A-003048FFD734.root')
)
...
process.corrPfMetType1Puppi = cms.EDProducer("PFJetMETcorrInputProducer",
    ...
    #jetCorrLabelRes = cms.InputTag("ak4PFL1FastL2L3ResidualCorrector"),
    #offsetCorrLabel = cms.InputTag("ak4PFL1FastjetCorrector"),
...
process.particleFlowDisplacedVertexPuppi = cms.EDProducer("PFDisplacedVertexProducer",
    avfParameters = cms.PSet(
        Tini = cms.double(256.0),
        ratio = cms.double(0.25),
        sigmacut = cms.double(6.0)
...
process.patJetFlavourAssociationPuppi = cms.EDProducer("JetFlavourClustering",
    ...
    partons = cms.InputTag("patJetPartonsPuppi","algorithmicPartons"),
    rParam = cms.double(0.4)
)
...
process.patPFMetT0CorrPuppi = cms.EDProducer("Type0PFMETcorrInputProducer",
    ...
    srcPFCandidateToVertexAssociations = cms.InputTag("pfCandidateToVertexAssociationPuppi")
)
...
process.pfCandidateToVertexAssociationPuppi = cms.EDProducer("PFCand_AssoMap",
    AssociationType = cms.InputTag("Both"),
    BeamSpot = cms.InputTag("offlineBeamSpot"),
    ConversionsCollection = cms.InputTag("allConversions"),
    FinalAssociation = cms.untracked.int32(1),
    GetCleanedCollections = cms.bool(False),
    MaxNumberOfAssociations = cms.int32(1),
    NIVertexCollection = cms.InputTag("particleFlowDisplacedVertexPuppi"),
    PFCandidateCollection = cms.InputTag("particleFlow"),
    UseBeamSpotCompatibility = cms.untracked.bool(True),
    V0KshortCollection = cms.InputTag("generalV0Candidates","Kshort"),
    V0LambdaCollection = cms.InputTag("generalV0Candidates","Lambda"),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    outputCommands = cms.untracked.vstring('keep *_slimmedMETs_*_RERUN', 
        ...
        'keep *_selectedPatJetsPuppi_*_*',
        'keep *_puppiNoLep_*_*',
        #'keep patJets_selectedPatJetsForMetT1T2CorrPuppi_*_*'
        ),
...
process.patMetModuleSequencePuppi = cms.Sequence(process.pfMetPuppi+process.ak4PFJetsPuppi+process.basicJetsForMetPuppi+process.jetSelectorForMetPuppi+process.cleanedPatJetsPuppi+process.patPFMetPuppi+process.metrawCaloPuppi+process.genMetExtractorPuppi)
...
process.patPFMetT0CorrSequencePuppi = cms.Sequence(process.selectedVerticesForPFMEtCorrType0Puppi+process.selectedPrimaryVertexHighestPtTrackSumForPFMEtCorrType0Puppi+process.particleFlowDisplacedVertexPuppi+process.pfCandidateToVertexAssociationPuppi+process.patPFMetT0CorrPuppi)
